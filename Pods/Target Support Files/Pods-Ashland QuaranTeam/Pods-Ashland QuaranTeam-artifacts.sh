...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Stripe/InternalFrameworks/static/Stripe3DS2.xcframework" "" "false" "ios-arm64/libStripe3DS2.a" "ios-arm64_x86_64-maccatalyst/libStripe3DS2.a" "ios-arm64_x86_64-simulator/libStripe3DS2.a"
fi
